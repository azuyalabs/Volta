...
namespace spec\Volta\Domain\Exception\Manufacturer;

use PhpSpec\ObjectBehavior;
use Volta\Domain\Exception\Exception;

class BlankManufacturerNameExceptionSpec extends ObjectBehavior
{
    ...
    {
        $this->getMessage()->shouldBe('manufacturer name can not be blank');
    }
}
