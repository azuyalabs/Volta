...
namespace spec\Volta\Domain\Exception;

use PhpSpec\ObjectBehavior;
use Volta\Domain\Exception\Exception;

class NoCalibrationsExceptionSpec extends ObjectBehavior
{
    ...
    {
        $this->getMessage()->shouldBe('there are no calibrations with this name');
    }
}
