...
class MinimumBedTemperatureExceededAbsoluteMaximumExceptionSpec extends ObjectBehavior
{
    ...
    {
        $this->getMessage()->shouldBe('minimum bed temperature can not exceed absolute maximum');
    }
}
