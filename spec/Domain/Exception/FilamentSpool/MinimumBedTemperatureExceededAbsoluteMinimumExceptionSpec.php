...
class MinimumBedTemperatureExceededAbsoluteMinimumExceptionSpec extends ObjectBehavior
{
    ...
    {
        $this->getMessage()->shouldBe('minimum bed temperature can not exceed absolute minimum');
    }
}
