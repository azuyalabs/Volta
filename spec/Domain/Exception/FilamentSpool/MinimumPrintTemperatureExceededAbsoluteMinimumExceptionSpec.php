...
class MinimumPrintTemperatureExceededAbsoluteMinimumExceptionSpec extends ObjectBehavior
{
    ...
    {
        $this->getMessage()->shouldBe('minimum print temperature can not exceed absolute minimum');
    }
}
