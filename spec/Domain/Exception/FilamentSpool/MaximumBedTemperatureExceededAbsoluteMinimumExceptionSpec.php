...
class MaximumBedTemperatureExceededAbsoluteMinimumExceptionSpec extends ObjectBehavior
{
    ...
    {
        $this->getMessage()->shouldBe('maximum bed temperature can not exceed absolute minimum');
    }
}
