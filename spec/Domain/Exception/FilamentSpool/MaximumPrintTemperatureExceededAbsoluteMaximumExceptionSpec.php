...
class MaximumPrintTemperatureExceededAbsoluteMaximumExceptionSpec extends ObjectBehavior
{
    ...
    {
        $this->getMessage()->shouldBe('maximum print temperature can not exceed absolute maximum');
    }
}
