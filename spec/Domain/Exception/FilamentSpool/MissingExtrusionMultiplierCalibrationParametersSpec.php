...
class MissingExtrusionMultiplierCalibrationParametersSpec extends ObjectBehavior
{
    ...
    {
        $this->getMessage()->shouldBe('extrusion multiplier calibration has no parameters');
    }
}
