...
<template>
    <create-screen resource="products" :title="$t('edit.title')">
        <b-form
            class="mt-3"
            id="product"
            @submit="onSubmit"
...
export default {
    ...
    created() {
        ...
        axios.get('/api/products/' + this.$route.params.id).then(response => {
            ...
            this.form.manufacturer = this.form.manufacturer.attributes.id;
        });
    },
    ...
    methods: {
        onSubmit(evt) {
            ...
            axios
                .patch('/api/products/' + this.$route.params.id, this.form)
                .then(response => {
