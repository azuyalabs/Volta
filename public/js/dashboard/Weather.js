...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"@babel/preset-env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"]},\"forceAllTransforms\":true}]],\"plugins\":[\"@babel/plugin-proposal-object-rest-spread\",[\"@babel/plugin-transform-runtime\",{\"helpers\":false}],\"@babel/plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/components/Dashboard/Weather.vue":
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers__ = __webpack_require__("./resources/js/helpers.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment_timezone__ = __webpack_require__("./node_modules/moment-timezone/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_mathjs__ = __webpack_require__("./node_modules/mathjs/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mixins: [__WEBPACK_IMPORTED_MODULE_1_vue_save_state___default.a],
  props: ['position'],
  data: function data() {
    return {
      state: 'unknown',
  ...
  created: function created() {
    ...
    if (!this.temperature.value) {
      __WEBPACK_IMPORTED_MODULE_4_axios___default.a.post('/api/dashboard/update/weather');
    }

    this.som = typeof window.Volta.preferences.dashboard.weather === 'undefined' ? 'metric' : window.Volta.preferences.dashboard.weather.system_of_measure;
    this.$root.echo.channel('weather.' + window.Volta.city).listen('Weather.WeatherFetched', function (response) {
      _this.temperature.uom = '&degC';
      var temperature = response.weather['temperature']['value'];

      if (_this.som === 'imperial') {
        _this.temperature.uom = '&degF';
        var temp = __WEBPACK_IMPORTED_MODULE_5_mathjs___default.a.unit(temperature, 'degC');
        temperature = temp.toNumeric('degF');
      }

      _this.temperature.value = Object(__WEBPACK_IMPORTED_MODULE_2__helpers__["g" /* numberFormat */])(temperature, 1);
      _this.humidity.value = Object(__WEBPACK_IMPORTED_MODULE_2__helpers__["g" /* numberFormat */])(response.weather['humidity']['value'], 0);
      _this.humidity.uom = response.weather['humidity']['uom'];
      _this.windspeed.uom = response.weather['windspeed']['uom'];
      var wind_speed = response.weather['windspeed']['value'];

      if (_this.som === 'imperial') {
        _this.windspeed.uom = 'm/h';
        var speed = __WEBPACK_IMPORTED_MODULE_5_mathjs___default.a.unit(wind_speed, 'meters / second');
        wind_speed = speed.toNumeric('miles / hour');
      }

      _this.windspeed.value = Object(__WEBPACK_IMPORTED_MODULE_2__helpers__["g" /* numberFormat */])(wind_speed, 0);
      _this.state = response.weather['state'];
      _this.sun = response.weather['sun'];
      _this.icon = _this.weatherIcon(response.weather['state']);
    });
  },
  methods: {
    numberFormat: __WEBPACK_IMPORTED_MODULE_2__helpers__["g" /* numberFormat */],
    getSaveStateConfig: function getSaveStateConfig() {
      return {
        cacheKey: 'weather'
      };
    },
    sunIsAboveHorizon: function sunIsAboveHorizon() {
      return __WEBPACK_IMPORTED_MODULE_3_moment_timezone___default.a.tz().utc().isBetween(this.sun['rise'], this.sun['set']);
    },
    weatherIcon: function weatherIcon(state) {
      var iconMappingDayTime = {
        Drizzle: 'wi-sprinkle',
      ...
      return this.sunIsAboveHorizon() === true ? iconMappingDayTime[state] : iconMappingNightTime[state];
    }
  }
});
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-22569bfe\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/components/Dashboard/Weather.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "tile",
    { attrs: { position: _vm.position, modifiers: "weather" } },
    [
      _c("section", { staticClass: "weather-main" }, [
        _c("div", { staticClass: "weather-main__icon" }, [
          _c("i", { staticClass: "wi", class: _vm.icon })
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "weather-main__temperature" }, [
          _vm._v("\n            " + _vm._s(_vm.temperature.value) + " "),
          _c("span", {
            staticClass: "weather-main__uom",
            domProps: { innerHTML: _vm._s(_vm.temperature.uom) }
          })
        ])
      ]),
      _vm._v(" "),
      _c("section", { staticClass: "weather-details" }, [
        _c("div", {
          staticClass: "weather-details__state",
          domProps: { textContent: _vm._s(_vm.$t("state." + _vm.state)) }
        }),
        _vm._v(" "),
        _c("div", { staticClass: "weather-details__other" }, [
          _c("span", [
            _c("i", { staticClass: "wi wi-humidity" }),
            _vm._v(_vm._s(_vm.humidity.value) + _vm._s(_vm.humidity.uom))
          ]),
          _vm._v(" "),
          _c("span", [
            _c("i", { staticClass: "wi wi-strong-wind" }),
            _vm._v(
              _vm._s(_vm.windspeed.value) + " " + _vm._s(_vm.windspeed.uom)
            )
          ])
        ])
      ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-22569bfe", module.exports)
  }
}
...
/***/ "./resources/js/components/Dashboard/Weather.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"@babel/preset-env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"]},\"forceAllTransforms\":true}]],\"plugins\":[\"@babel/plugin-proposal-object-rest-spread\",[\"@babel/plugin-transform-runtime\",{\"helpers\":false}],\"@babel/plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/components/Dashboard/Weather.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-22569bfe\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/components/Dashboard/Weather.vue")
/* template functional */
...
Component.options.__file = "resources/js/components/Dashboard/Weather.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-22569bfe", Component.options)
  } else {
    hotAPI.reload("data-v-22569bfe", Component.options)
  }
