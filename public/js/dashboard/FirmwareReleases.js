...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"@babel/preset-env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"]},\"forceAllTransforms\":true}]],\"plugins\":[\"@babel/plugin-proposal-object-rest-spread\",[\"@babel/plugin-transform-runtime\",{\"helpers\":false}],\"@babel/plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/components/Dashboard/FirmwareReleases.vue":
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    if (_.isEmpty(this.firmware_releases)) {
      __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post('/api/dashboard/update/firmwares');
    }

    this.$root.echo.channel('firmware_releases').listen('FirmwareReleases.FirmwareReleasesFetched', function (response) {
      _this.firmware_releases = response.firmware_releases;
    });
  },
  methods: {
    diffForHumans: __WEBPACK_IMPORTED_MODULE_2__helpers__["c" /* diffForHumans */],
    isNew: __WEBPACK_IMPORTED_MODULE_2__helpers__["f" /* isNew */],
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-4f3ec80d\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/components/Dashboard/FirmwareReleases.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var render = function() {
  ...
  return _c("tile", { attrs: { position: _vm.position } }, [
    _c("section", [
      _c("h1", { domProps: { textContent: _vm._s(_vm.$t("title")) } }),
      _vm._v(" "),
      _vm.firmware_releases.length > 0
        ? _c(
            "ul",
            _vm._l(_vm.firmware_releases, function(firmware) {
              return _c("li", { staticClass: "firmware__release" }, [
                _c("span", {
                  staticClass: "firmware__release-version",
                  domProps: {
                    textContent: _vm._s(firmware.name + " " + firmware.version)
                  }
                }),
                _vm._v(" "),
                _vm.isNew(firmware.release_date)
                  ? _c("span", {
                      staticClass: "pill-new",
                      domProps: { textContent: _vm._s(_vm.$t("new")) }
                    })
                  : _c("span", {
                      staticClass: "firmware__release-date",
                      domProps: {
                        textContent: _vm._s(
                          _vm.diffForHumans(firmware.release_date)
                        )
                      }
                    })
              ])
        ...
        : _c("div", { staticClass: "content-center" }, [
            _c("span", {
              domProps: { textContent: _vm._s(_vm.$t("no_releases")) }
            })
          ])
    ])
  ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4f3ec80d", module.exports)
  }
}
...
/***/ "./resources/js/components/Dashboard/FirmwareReleases.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"@babel/preset-env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"]},\"forceAllTransforms\":true}]],\"plugins\":[\"@babel/plugin-proposal-object-rest-spread\",[\"@babel/plugin-transform-runtime\",{\"helpers\":false}],\"@babel/plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/components/Dashboard/FirmwareReleases.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-4f3ec80d\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/components/Dashboard/FirmwareReleases.vue")
/* template functional */
...
Component.options.__file = "resources/js/components/Dashboard/FirmwareReleases.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4f3ec80d", Component.options)
  } else {
    hotAPI.reload("data-v-4f3ec80d", Component.options)
  }
