...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"@babel/preset-env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"]},\"forceAllTransforms\":true}]],\"plugins\":[\"@babel/plugin-proposal-object-rest-spread\",[\"@babel/plugin-transform-runtime\",{\"helpers\":false}],\"@babel/plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/components/Dashboard/Holidays.vue":
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    if (_.isEmpty(this.holidays)) {
      __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post('/api/dashboard/update/holidays');
    }

    this.$root.echo.channel('holidays.' + window.Volta.country).listen('Holidays.HolidaysFetched', function (response) {
      _this.holidays = response.holidays;
      _this.provider = response.provider;
    });
  },
  methods: {
    dateFormat: __WEBPACK_IMPORTED_MODULE_2__helpers__["b" /* dateFormat */],
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-42ba3301\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/components/Dashboard/Holidays.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var render = function() {
  ...
  return _c("tile", { attrs: { position: _vm.position } }, [
    _c("section", { staticClass: "holidays__header" }, [
      _c("h1", { domProps: { textContent: _vm._s(_vm.$t("title")) } }),
      _vm._v(" "),
      _vm.holidays.length > 0
        ? _c("span", {
            staticClass: "holidays__header-country",
            domProps: {
              textContent: _vm._s(_vm.$t("providers." + _vm.provider))
            }
          })
        : _vm._e()
    ]),
      ...
      _vm.holidays.length > 0
        ? _c(
            ...
            _vm._l(_vm.holidays, function(holiday) {
              return _c("li", { staticClass: "holidays" }, [
                _c("span", {
                  staticClass: "holidays__holiday-name",
                  domProps: { textContent: _vm._s(holiday.name) }
                }),
                _vm._v(" "),
                _c("span", {
                  staticClass: "holidays__holiday-date",
                  domProps: {
                    textContent: _vm._s(
                      _vm.diffForHumans(holiday.date) +
                        " (" +
                        _vm.dateFormat(holiday.date, "MMMM Do") +
                        ")"
                    )
                  }
                })
        ...
        : _c("div", { staticClass: "content-center" }, [
            _c("span", {
              domProps: { textContent: _vm._s(_vm.$t("no_holidays")) }
            })
          ])
    ])
  ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-42ba3301", module.exports)
  }
}
...
/***/ "./resources/js/components/Dashboard/Holidays.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"@babel/preset-env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"]},\"forceAllTransforms\":true}]],\"plugins\":[\"@babel/plugin-proposal-object-rest-spread\",[\"@babel/plugin-transform-runtime\",{\"helpers\":false}],\"@babel/plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/components/Dashboard/Holidays.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-42ba3301\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/components/Dashboard/Holidays.vue")
/* template functional */
...
Component.options.__file = "resources/js/components/Dashboard/Holidays.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-42ba3301", Component.options)
  } else {
    hotAPI.reload("data-v-42ba3301", Component.options)
  }
