...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"@babel/preset-env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"]},\"forceAllTransforms\":true}]],\"plugins\":[\"@babel/plugin-proposal-object-rest-spread\",[\"@babel/plugin-transform-runtime\",{\"helpers\":false}],\"@babel/plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/components/Dashboard/Printer.vue":
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_save_state__ = __webpack_require__("./node_modules/vue-save-state/dist/save-state.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_save_state___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue_save_state__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_js__ = __webpack_require__("./resources/js/helpers.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__svg_icons_compiled_printer_extruder_js__ = __webpack_require__("./resources/svg-icons/compiled/printer-extruder.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__svg_icons_compiled_printer_extruder_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__svg_icons_compiled_printer_extruder_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__svg_icons_compiled_printer_heatbed_js__ = __webpack_require__("./resources/svg-icons/compiled/printer-heatbed.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__svg_icons_compiled_printer_heatbed_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__svg_icons_compiled_printer_heatbed_js__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mixins: [__WEBPACK_IMPORTED_MODULE_1_vue_save_state___default.a, __WEBPACK_IMPORTED_MODULE_1_vue_save_state___default.a],
  props: {
    id: {
      type: String,
      required: true
  ...
  computed: {
    ...
    jobCompleted: function jobCompleted() {
      return ['finishing', 'finished'].includes(this.printer.state);
    },
    printerURL: function printerURL() {
  ...
  created: function created() {
    ...
    this.$root.echo.channel("printer.".concat(this.id)).listen('PrinterMonitor.PrinterStatusFetched', function (response) {
      _this.printer = response.status;
      _this.lastUpdated = Date.now();
    });
  },
  methods: {
    formatETA: __WEBPACK_IMPORTED_MODULE_2__helpers_js__["d" /* formatETA */],
    formatPrintJobDuration: __WEBPACK_IMPORTED_MODULE_2__helpers_js__["e" /* formatPrintJobDuration */],
    numberFormat: __WEBPACK_IMPORTED_MODULE_2__helpers_js__["g" /* numberFormat */],
    getSaveStateConfig: function getSaveStateConfig() {
      return {
        cacheKey: "printer.".concat(this.id)
      };
    },
    checkFreshness: function checkFreshness() {
      var delta = (Date.now() - this.lastUpdated) / 1000;
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-2577a924\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/components/Dashboard/Printer.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "tile",
    { attrs: { position: _vm.position, modifiers: "printer", id: _vm.id } },
    [
      _c("section", { staticClass: "printer-header" }, [
        _c("div", { staticClass: "printer-header_name" }, [
          _vm._v("\n            " + _vm._s(_vm.printerURL[0])),
          _vm.printerURL[1] ? _c("span", [_vm._v("@")]) : _vm._e(),
          _c("a", {
            attrs: {
              title: _vm.$t("open_octoprint"),
              href: "http://" + _vm.printerURL[1],
              target: "_blank"
            },
            domProps: { textContent: _vm._s(_vm.printerURL[1]) }
          })
        ])
      ]),
      _vm._v(" "),
      _vm.isRunning || _vm.jobCompleted
        ? _c("section", { staticClass: "printer-main" }, [
            _c("div", { staticClass: "printer-main-printjob-wrap" }, [
              _c("div", { staticClass: "printer-main-printjob" }, [
                _c("div", {
                  staticClass: "printer-main-printjob_text",
                  domProps: {
                    textContent: _vm._s(_vm.printer.printjob.filename)
                  }
                })
              ])
            ]),
            ...
            _c(
              "div",
              { staticClass: "printer-main-progress" },
              [
                _c("vm-progress", {
                  attrs: {
                    type: "circle",
                    percentage: _vm.printer.printjob.progress,
                    "stroke-width": 15
                  }
                }),
                _vm._v(" "),
                _vm.isRunning
                  ? _c("div", { staticClass: "printer-main-progress-job" }, [
                      _c(
                        "span",
                        { staticClass: "printer-main-progress-job_title" },
                        [_vm._v("ETA")]
                      ),
                      _vm._v(" "),
                      _vm.printer.printjob.time_remaining !== 0
                        ? _c("span", {
                            staticClass: "printer-main-progress-job_time",
                            domProps: {
                              textContent: _vm._s(
                                _vm.formatETA(
                                  _vm.printer.printjob.time_remaining
                                )
                              )
                            }
                          })
                      ...
                      _vm._v(" "),
                      _c("span", {
                        staticClass: "printer-main-progress-job_remaining",
                        domProps: {
                          textContent: _vm._s(
                            _vm.formatPrintJobDuration(
                              _vm.printer.printjob.time_remaining
                            )
                          )
                        }
                      ...
                      _vm._v(" "),
                      _c("span", {
                        staticClass: "printer-main-progress-status",
                        domProps: { textContent: _vm._s(_vm.printer.state) }
                      })
                    ])
                  : _vm._e(),
                _vm._v(" "),
                  ...
                  ? _c("div", { staticClass: "printer-main-progress-job" }, [
                      ...
                      _c("span", {
                        ...
                        domProps: {
                          textContent: _vm._s(
                            _vm.formatPrintJobDuration(
                              _vm.printer.printjob.time_elapsed
                            )
                          )
                        }
                      }),
                      ...
                      _c(
                        "span",
                        { staticClass: "printer-main-progress-usage" },
                        [
                          _vm._v(
                            "Filament:\n                    " +
                              _vm._s(
                                _vm.numberFormat(
                                  _vm.printer.printjob.filament_length / 1000
                                )
                              ) +
                              "m"
                          )
        ...
        : !_vm.isOffline
        ? _c("section", { staticClass: "printer-main content-center" }, [
            _c("span", [_vm._v(_vm._s(_vm.$t("printer_states.ready")))])
          ])
        : _c("section", { staticClass: "printer-main content-center" }, [
            _vm._v(
              "\n        " + _vm._s(_vm.$t("printer_states.offline")) + "\n    "
            )
          ]),
      _vm._v(" "),
      _vm.isRunning
        ? _c("section", { staticClass: "printer-footer" }, [
            _c(
              "span",
              [
                _c("svgicon", {
                  staticClass: "printer-footer-icon",
                  attrs: { icon: "printer-heatbed" }
                }),
                _vm._v(
                  "\n            " +
                    _vm._s(_vm.printer.heatbed_temperature.current) +
                    "°C\n        "
                )
              ],
              1
            ...
            _c(
              ...
              [
                _c("svgicon", {
                  staticClass: "printer-footer-icon",
                  attrs: { icon: "printer-extruder" }
                }),
                _vm._v(
                  "\n            " +
                    _vm._s(_vm.printer.extruder_temperature.current) +
                    "°C\n        "
                )
              ],
              1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2577a924", module.exports)
  }
}
...
var _localStorage = __webpack_require__("./node_modules/vue-save-state/dist/local-storage.js");
...
/***/ "./resources/js/components/Dashboard/Printer.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"@babel/preset-env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"]},\"forceAllTransforms\":true}]],\"plugins\":[\"@babel/plugin-proposal-object-rest-spread\",[\"@babel/plugin-transform-runtime\",{\"helpers\":false}],\"@babel/plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/components/Dashboard/Printer.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-2577a924\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/components/Dashboard/Printer.vue")
/* template functional */
...
Component.options.__file = "resources/js/components/Dashboard/Printer.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2577a924", Component.options)
  } else {
    hotAPI.reload("data-v-2577a924", Component.options)
  }
...
/***/ "./resources/svg-icons/compiled/printer-extruder.js":
/***/ (function(module, exports, __webpack_require__) {
...
icon.register({
  'printer-extruder': {
    ...
    height: 16,
    viewBox: '0 0 30 30',
    data: '<g _fill="none" _stroke="#000" stroke-width="1.7" stroke-linecap="round"><path pid="0" d="M6.711 16.573h6.06M17.318 16.573h5.971"/></g><g _fill="none" _stroke="#000"><path pid="1" stroke-width="1.3" stroke-linejoin="round" d="M12.971 14.643h4.102v5.977h-4.102z"/><path pid="2" d="M14.223 22.796h1.598" stroke-width="1.7" stroke-linecap="round"/></g><path pid="3" d="M8.41 6.861s.161 2.05.887 2.618c1.263.988 3.56-.624 4.793.4.815.676.843 3.062.843 3.062" _fill="none" _stroke="#000" stroke-linecap="round"/>'
  }
});

/***/ }),

/***/ "./resources/svg-icons/compiled/printer-heatbed.js":
/***/ (function(module, exports, __webpack_require__) {
...
icon.register({
  'printer-heatbed': {
    ...
    height: 16,
    viewBox: '0 0 30 30',
    data: '<g _fill="none" _stroke="#000" stroke-width="1.7" stroke-linecap="round"><path pid="0" d="M11.025 8.65s-1.36.78-.917 1.956c.385 1.02 2.168 1.85 1.768 3.414-.196.766-.917 1.248-.917 1.248M15.047 8.65s-1.36.78-.917 1.956c.384 1.02 2.167 1.85 1.768 3.414-.196.766-.917 1.248-.917 1.248M19.068 8.65s-1.36.78-.917 1.956c.385 1.02 2.168 1.85 1.768 3.414-.196.766-.917 1.248-.917 1.248"/></g><g _fill="none" _stroke="#000" stroke-linecap="round"><path pid="1" d="M9.052 21.374h11.896" stroke-width="1.664"/><path pid="2" d="M6.625 19.146h16.75" stroke-width="1.265"/></g>'
  }
});
