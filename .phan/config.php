...
return [
    ...
    'directory_list' => [
        ...
        'database/factories',
        'database/seeds',
        'vendor/azuyalabs/yasumi/src/Yasumi',
        'vendor/cache/predis-adapter',
        'vendor/cknow/laravel-money/src',
        'vendor/cviebrock/eloquent-sluggable/src',
        'vendor/dms/phpunit-arraysubset-asserts/src',
        'vendor/doctrine/dbal/lib/Doctrine/DBAL',
        'vendor/erusev/parsedown-extra',
